...
def main(ui, args: argparse.Namespace):
    ...
    if args.file and first_launch:
        ...
        menu_choice = prompt_select("Choose:", list(MainMenu), exclude=exclude)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        "--batch",
        nargs="+",
        help="Process multiple lua files in batch mode",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--auto-update",
        action="store_true",
        help="Automatically update manifests without user interaction",
    )
    parser.add_argument("--export-ids", help="Export AppList IDs to specified file")
    parser.add_argument(
        "--dry-run",
        action="store_true",
